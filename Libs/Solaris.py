...
from Libs.Units import SECOND, Units, BYTE
        ...
        def addDisks(outPut):
            ...
            for line in lines:
                ...
                if diskDict['disk'] in ioPathsMap:
                    ...
                    tmp = {diskDict['disk']: {diskDict['controller']: [diskDict['target']],
    ...
    def _breakApartDeviceName(self, device):
        ...
        if deviceMatch:
            disk = {'controller': deviceMatch.group(1),
                    ...
                    'base_name': str(deviceMatch.group(1)) +
                                 str(deviceMatch.group(2)) +
                                 str(deviceMatch.group(3))}
        return disk
